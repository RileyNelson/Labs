...
public class Recursion {
    ...
    public static boolean isPalindrome(String word){
        ...
        int i = 0;
        if(Character.toUpperCase(word.charAt(i)) != Character.toUpperCase(word.charAt(word.length() - 1))) {
            return false;
        }
        else if(Character.toUpperCase(word.charAt(i)) == Character.toUpperCase(word.charAt(word.length() - 1))){
            return true;
        }
        else{
            i++;
            return isPalindrome(word.substring(i, word.indexOf(word.length() -1)));
        }
    }
    ...
    public static void main(String [] args){
        ...
        //Note: in zyBooks the main in Recursion.java will run instead, and it is all of the below statements.
